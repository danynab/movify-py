...
+function (t) {
    ...
    i.VERSION = "3.3.2", i.TRANSITION_DURATION = 300, i.BACKDROP_TRANSITION_DURATION = 150, i.DEFAULTS = {
        ...
        this.$element.trigger(o), this.isShown || o.isDefaultPrevented() || (this.isShown = !0, this.checkScrollbar(), this.setScrollbar(), this.$body.addClass("modal-open"), this.escape(), this.resize(), this.$element.on("click.dismiss.bs.modal", '[data-dismiss="modal"]', t.proxy(this.hide, this)), this.backdrop(function () {
            ...
            s.$element.parent().length || s.$element.appendTo(s.$body), s.$element.show().scrollTop(0), s.options.backdrop && s.adjustBackdrop(), s.adjustDialog(), o && s.$element[0].offsetWidth, s.$element.addClass("in").attr("aria-hidden", !1), s.enforceFocus();
    ...
    i.VERSION = "3.3.2", i.RESET = "affix affix-top affix-bottom", i.DEFAULTS = {
        ...
        var o = this.$target.scrollTop(), n = this.$element.offset(), a = this.$target.height();
        ...
        var r = null == this.affixed, l = r ? o : n.top, h = r ? a : e;
        ...
        if (this.$element.is(":visible")) {
            var e = this.$element.height(), s = this.options.offset, o = s.top, n = s.bottom, a = t("body").height();
    ...
    t.fn.collapse = i, t.fn.collapse.Constructor = s, t.fn.collapse.noConflict = function () {
        ...
        var n = e(o), a = n.data("bs.collapse"), r = a ? "toggle" : t.extend({}, o.data(), {trigger: this});
        i.call(n, r)
    })
}(jQuery), +function (t) {
    "use strict";
    ...
    e.VERSION = "3.3.2", e.DEFAULTS = {offset: 10}, e.prototype.getScrollHeight = function () {
        ...
        for (t = o.length; t--;)a != n[t] && e >= o[t] && (!o[t + 1] || e <= o[t + 1]) && this.activate(n[t])
